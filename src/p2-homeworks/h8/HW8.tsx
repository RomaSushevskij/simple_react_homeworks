...
function HW8() {
    ...
    const finalPeople = people.map((p: UserType) => (
        <div key={p._id}>
            <div className={styles.peopleRow}>
                <div className={styles.peopleBlock}>{p.name}</div>
                <div className={styles.agesBlock}>{p.age}</div>
            </div>
        </div>
    ))
    ...
    return (
        <div className={style.homeWork_8}>
            <div className={style.title}>homeworks 8</div>
